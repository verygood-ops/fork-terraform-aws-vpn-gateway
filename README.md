...
| <a name="input_transport_transit_gateway_attachment_id"></a> [transport\_transit\_gateway\_attachment\_id](#input\_transport\_transit\_gateway\_attachment\_id) | Required when outside\_ip\_address\_type is set to PrivateIpv4. The attachment ID of the Transit Gateway attachment to Direct Connect Gateway | `string` | `null` | no |
